...
class ClicksControllerTest < ActionController::TestCase
  ...
  test "should create click" do
    assert_difference('Click.count') do
      post :create, click: { click_time: @click.click_time, click_type: @click.click_type, name: @click.name }
    end
  ...
  test "should update click" do
    put :update, id: @click, click: { click_time: @click.click_time, click_type: @click.click_type, name: @click.name }
    assert_redirected_to click_path(assigns(:click))
  end
